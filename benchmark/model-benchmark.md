...
> 측정일: 2026-05-31 (UTC)  
> 원본 데이터: [`results/full_model_benchmark_results.json`](results/full_model_benchmark_results.json)  
> 재현: `python benchmark/scripts/full_model_benchmark.py`
...
uv run python benchmark/scripts/full_model_benchmark.py   # 4종 프롬프트 종합
uv run python benchmark/scripts/body_2500_benchmark.py    # 2000~3000자 본문 전용
```
...
> 측정일: 2026-05-31 · 원본: [`results/body_2500_benchmark_results.json`](results/body_2500_benchmark_results.json)
